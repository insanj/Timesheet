...
SWIFT_MODULE_NAMESPACE_PUSH("BulletinBoard")
@class NSCoder;

/// A view that contains an activity indicator. The indicator is centered inside the view.
SWIFT_CLASS("_TtC13BulletinBoard17ActivityIndicator")
...
/// You create a bulletin manager by passing a root <code>BulletinItem</code>, that contains the data to display.
...
/// You must call the <code>prepare</code> function before displaying the view controller or changing the current
/// item.
/// <code>BulletinManager</code> must be used on the main thread only.
SWIFT_CLASS("_TtC13BulletinBoard15BulletinManager")
@interface BulletinManager : NSObject <UIViewControllerTransitioningDelegate>
...
SWIFT_CLASS("_TtC13BulletinBoard22BulletinViewController")
...
SWIFT_CLASS("_TtC13BulletinBoard29DimmingPresentationController")
...
/// This style of button works best with a solid background color. Use the <code>setBackgroundColor</code>
/// function on <code>UIButton</code> to set one.
SWIFT_CLASS("_TtC13BulletinBoard15HighlightButton")
